...
public class SystemProfile {
    ...
    public static class AdtConfig {
        ...
        /** Optional browser entry URL for manual SSO/session setup before the ADT reentrance-ticket step. */
        @JsonProperty("browser_entry_url")
        @JsonAlias("idp_url")
        ...
        public String getBrowserEntryUrl() { return browserEntryUrl; }
        public void setBrowserEntryUrl(String browserEntryUrl) { this.browserEntryUrl = browserEntryUrl; }
