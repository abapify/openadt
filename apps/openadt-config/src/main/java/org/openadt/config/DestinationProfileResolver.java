...
public final class DestinationProfileResolver {
    ...
    private static void applyProfileDirectAdtFields(SystemProfile.AdtConfig adt, SystemProfile.ProfileConfig profile) {
        ...
        if (profile.getBaseUrl() != null) {
            adt.setBaseUrl(AdtHttpFrontendUrls.normalizeToOrigin(profile.getBaseUrl().trim()));
        }
        if (profile.getBrowserEntryUrl() != null) {
            adt.setBrowserEntryUrl(profile.getBrowserEntryUrl().trim());
        }
    ...
    private static void applyProfileNestedAdtFields(SystemProfile.AdtConfig adt, SystemProfile.AdtConfig profileAdt) {
        ...
        if (profileAdt.getBaseUrl() != null) {
            adt.setBaseUrl(AdtHttpFrontendUrls.normalizeToOrigin(profileAdt.getBaseUrl().trim()));
        }
        if (profileAdt.getBrowserEntryUrl() != null) {
            adt.setBrowserEntryUrl(profileAdt.getBrowserEntryUrl().trim());
        }
    ...
    private static SystemProfile.AdtConfig cloneAdt(SystemProfile.AdtConfig source) {
        ...
        copy.setBrowserEntryUrl(source.getBrowserEntryUrl());
