 ...
 */
public final class LoopbackHubTlsProbe {
    private LoopbackHubTlsProbe() {
    }

    public static final class UnavailableHubException extends IOException {
    ...
    public static boolean isUnavailableHubFailure(Throwable error) {
    ...
    public static X509Certificate probeCertificate(InetAddress loopback, int port) throws IOException {
