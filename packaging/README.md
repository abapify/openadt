...
Release zip contains only OpenADT binaries (MIT). SAP ADT/JCo are **never** bundled — run `openadt setup` so fetch/proxy use your licensed Eclipse `adt_plugins_dir` and `~/.openadt/runtime/openadt-full.jar`.
