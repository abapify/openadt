...
const SEMANTIC_CACHE_SUFFIX = join(
  ".metadata",
  ".plugins",
  "org.eclipse.core.resources.semantic",
  ".cache",
);
const DESTINATION_FILE = ".destination.properties";
...
export type DestinationImportMode = "auto" | "gui" | "openadt" | "none";
